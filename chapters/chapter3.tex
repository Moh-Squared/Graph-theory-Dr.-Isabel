...
\begin{center}
\begin{tikzpicture}[
    scale=1.2, % Slightly smaller than 1.5 to save space
    node_style/.style={circle, fill=black, inner sep=1.5pt},
    edge_style/.style={cyan, thick},
    weight_style/.style={cyan, font=\small}
]
...
\begin{minipage}{\textwidth}
    ...
    \tikzset{
        tiny_graph/.style={
            scale=0.7, % SCALED DOWN TO FIT PAGE
            baseline=(current bounding box.center),
            node_style/.style={circle, fill=black, inner sep=1.5pt},
            edge_style/.style={cyan, thick},
            weight_style/.style={cyan, font=\tiny}, % Smaller font
    ...
    \vspace{1em} % Small gap between rows
